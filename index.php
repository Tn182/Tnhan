            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="d-none d-lg-block">
                        <a href="login_register.html" class="navbar-icon bi-person smoothscroll"></a>
                    </div>
                </div>
            </div>
        </nav>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <h1 class="text-white text-center">HÃY BẮT ĐẦU QUAN TÂM ĐẾN SỨC KHỎE</h1>

                        <h6 class="text-center">Thế giới của sức khỏe</h6>
                    ...
                    <div class="col-lg-4 col-12 mb-4 mb-lg-0">
                        <div class="custom-block bg-white shadow-lg">
                            <a href="new2.html">
                                <div class="d-flex">
                                    <div>
                                        <h5 class="mb-2">Các lưu ý về một chế độ ăn uống lành mạnh</h5>

                                        <p class="mb-0">Chế độ ăn uống lành mạnh là một trong các yếu tố hàng đầu để cơ thể luôn khỏe mạnh. Để thực hành tốt chế độ ăn uống lành mạnh cần nắm rõ những vấn đề cơ bản về dinh dưỡng cũng như cách lựa chọn thực phẩm cho các bữa ăn.</p>
                                    </div>

                                    
                                </div>

                                <img src="image/new1.jpg" class="custom-block-image img-fluid" alt="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="custom-block custom-block-overlay">
                            <div class="d-flex flex-column h-100">
                                <img src="image/new2.jpg" class="custom-block-image img-fluid" alt="">

                                <div class="custom-block-overlay-text d-flex">
                                    <div>
                                        <h5 class="text-white mb-2">Chế độ ăn lành mạnh cần có những loại thực phẩm nào?</h5>

                                        <p class="text-white">Định nghĩa cơ bản nhất về chế độ ăn uống lành mạnh là nó hỗ trợ tốt nhất cho sức khỏe tổng thể và ngăn ngừa bệnh tật. Nghiên cứu cho thấy ăn một chế độ ăn đa dạng dựa trên thực phẩm chế biến tối thiểu, nhiều loại thực phẩm thực vật và hạn chế các món đã qua chế biến kỹ là cách tiếp cận tốt nhất cho hầu hết mọi người.</p>
                ...
                <div class="row">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="design-tab" data-bs-toggle="tab" data-bs-target="#design-tab-pane" type="button" role="tab" aria-controls="design-tab-pane" aria-selected="true">Sức khỏe</button>
                        </li>

                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="marketing-tab" data-bs-toggle="tab" data-bs-target="#marketing-tab-pane" type="button" role="tab" aria-controls="marketing-tab-pane" aria-selected="false">Video</button>
                        </li>

                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="finance-tab" data-bs-toggle="tab" data-bs-target="#finance-tab-pane" type="button" role="tab" aria-controls="finance-tab-pane" aria-selected="false">Bí quyết</button>
                        </li>
